 ...
 *
 * Certain SimLib types are exposed to the user as AutoPtrX pointers, which
...
class RefCountable {
 ...
 public:
  RefCountable() : ref_count(1) {
    ...
    if (false) {
      std::ostringstream o;
      o << "Ref countable - in one param constructor- "
  ...
  RefCountable(const RefCountable& rc) : ref_count(rc.getCount()) {
    ...
    if (false) {
      std::ostringstream o;
      o << "Ref countable - in copy constructor - "
        << ": " << ref_count << std::endl;
      //			tsprint( o, std::cout );
    }
#endif
...
class ManagedPtr {
 ...
 public:
  ManagedPtr() : _t(0), _rc(new RefCountable()), _deleter(0) {
    ...
    if (false) {
      std::ostringstream o;
      o << "ManagedPtr constr 1" << std::endl;
      //			tsprint( o, std::cout );
    }
#endif
  }
  ...
  ManagedPtr(T* t, RefCountable* rc) : _t(t), _rc(rc), _deleter(0) {
    ...
    if (false) {
      std::ostringstream o;
      o << "ManagedPtr constr 2" << std::endl;
      //			tsprint( o, std::cout );
    }
#endif
  }
  ...
  ManagedPtr(const ManagedPtr<T>& mp)
    ...
    if (false) {
      std::ostringstream o;
      o << "ManagedPtr copy constr" << std::endl;
      //			tsprint( o, std::cout );
    }
#endif
  }
  ...
  ManagedPtr<T>& operator=(const ManagedPtr<T>& mp) {
    ...
    if (false) {
      std::ostringstream o;
      o << "ManagedPtr operator=: " << std::endl;
      //			tsprint( o, std::cout );
    }
#endif
...
typedef ManagedPtr<std::wstring> WStringPtr;
typedef ManagedPtr<std::string> StringPtr;
...
typedef ManagedPtr<const std::string> ConstStringPtr;
