...
class TimeDurationAbstr {
 public:
  ...
  MISC_API static TimeDurationAbstrPtr make(__int64 hours, __int64 mins,
                                            __int64 secs, __int64 frac_sec);
...
class TimeDuration {
 ...
 public:
   ...
   */
  TimeDuration(__int64 hours, __int64 mins, __int64 secs = 0,
               __int64 frac_sec = 0)
...
inline std::string dateFormatToString(DateFormat dateFormat,
                                      const std::string& sep) {
  switch (dateFormat) {
    case us:
      return std::string("US (m") << sep << "d" << sep << "y)";
    case european:
      return std::string("EU (d") << sep << "m" << sep << "y)";
    case iso:
      return std::string("ISO (y") << sep << "m" << sep << "d)";
    case xyz:
      return std::string("d") << sep << "m" << sep << "y (ex: 25" << sep
                              << "Jan" << sep << "2010)";
    default:
...
class Date {
 ...
 private:
  void parse(const std::string& xdate, DateFormat format,
...
#define DEF_DATE_SEP "/-"
  MISC_API explicit Date(
      ...
      const std::string& separator = DEF_DATE_SEP) throw(DateException);

  MISC_API Date(const std::string& date,
                const std::string& format) throw(DateException);
  /**
  ...
  MISC_API std::string toString(DateFormat format,
