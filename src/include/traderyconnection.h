...
typedef boost::shared_ptr<TraderyCredentials> TraderyCredentialsPtr;
...
typedef boost::shared_ptr<TraderyAuthToken> TraderyAuthTokenPtr;
...
typedef tradery::ManagedPtr<Response> ResponsePtr;
...
typedef boost::shared_ptr<TraderyRequest> TraderyRequestPtr;
...
typedef tradery::ManagedPtr<TraderyConnection> TraderyConnectionPtr;
