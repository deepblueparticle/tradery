...
class BarSystem : public Runnable,
 ...
 public:
   ...
   * @see SeriesManagerI
   */
  void init(const DataCollection* data, PositionsManagerAbstr* positions,
            chart::Chart* chart,
            const ExplicitTrades* explicitTrades) throw(BarSystemException) {
    assert(data != 0);
    assert(positions != 0);
    assert(chart != 0);
    ...
    try {
      ...
      if (data != 0 && !_defBars)
        ...
        throw BarSystemException(BAR_SYSTEM_RECEIVED_NON_BAR_DATA_ERROR,
                                 "Bar system received non-bar data");
    } catch (std::bad_cast&) {
      throw BarSystemException(BAR_SYSTEM_RECEIVED_NON_BAR_DATA_ERROR,
                               "Bar system received non-bar data");
    }
  ...
  PositionId buyAtMarket(
      Index barIndex, size_t shares, const std::string& name,
  ...
  PositionId buyAtStop(
      Index barIndex, double stopPrice, size_t shares, const std::string& name,
      bool applyPositionSizing = true) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
  ...
  PositionId buyAtLimit(
      Index barIndex, double limitPrice, size_t shares, const std::string& name,
      bool applyPositionSizing = true) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
  ...
  bool sellAtClose(Index barIndex, Position pos, const std::string& name) throw(
      BarIndexOutOfRangeException, SellingShortPositionException,
      ClosingAlreadyClosedPositionException) {
    assert(_defBars);
  ...
  bool sellAtStop(
      Index barIndex, Position pos, double stopPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException) {
    assert(_defBars);
  ...
  bool sellAtStop(
      Index barIndex, PositionId pos, double stopPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException,
                                     PositionIdNotFoundException) {
  ...
  bool sellAtLimit(
      Index barIndex, Position pos, double limitPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException) {
    assert(_defBars);
  ...
  bool sellAtLimit(
      Index barIndex, PositionId pos, double limitPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException,
                                     PositionIdNotFoundException) {
  ...
  void closeAllAtMarket(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllAtMarket(bars(), barIndex, name);
  }

  void closeAllShortAtMarket(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllShortAtMarket(bars(), barIndex, name);
  }

  void closeAllLongAtMarket(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllLongAtMarket(bars(), barIndex, name);
  }

  void closeAllAtClose(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllAtClose(bars(), barIndex, name);
  }

  void closeAllShortAtClose(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllShortAtClose(bars(), barIndex, name);
  }

  void closeAllLongAtClose(Index barIndex, const std::string& name) throw(
      BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllLongAtClose(bars(), barIndex, name);
  }

  void closeAllShortAtLimit(
      Index barIndex, double price,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeAllShortAtLimit(bars(), barIndex, price, name);
  }

  void closeAllLongAtLimit(
      Index barIndex, double price,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
  ...
  void closeFirstLongAtMarketByShares(
      size_t shares, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
    positions().closeFirstLongAtMarketByShares(bars(), shares, barIndex, name);
  }

  void closeFirstShortAtMarketByShares(
      size_t shares, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
  ...
  PositionId buyAtMarket(
      Bars bars, Index barIndex, size_t shares,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    return positions().buyAtMarket(bars, barIndex, shares, name);
  }
  ...
  bool sellAtMarket(
      Bars bars, Index barIndex, Position pos,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException) {
    return positions().sellAtMarket(bars, barIndex, pos, name);
  ...
  bool sellAtMarket(
      Bars bars, Index barIndex, PositionId pos,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException,
                                     PositionIdNotFoundException) {
  ...
  bool sellAtStop(
      Bars bars, Index barIndex, Position pos, double stopPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException) {
    return positions().sellAtStop(bars, barIndex, pos, stopPrice, name);
  ...
  bool sellAtStop(
      Bars bars, Index barIndex, PositionId pos, double stopPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException,
                                     PositionIdNotFoundException) {
  ...
  bool sellAtLimit(
      Bars bars, Index barIndex, Position pos, double limitPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException) {
  ...
  bool sellAtLimit(
      Bars bars, Index barIndex, PositionId pos, double limitPrice,
      const std::string& name) throw(BarIndexOutOfRangeException,
                                     SellingShortPositionException,
                                     ClosingAlreadyClosedPositionException,
                                     PositionIdNotFoundException) {
  ...
  void closeAllAtMarket(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllAtMarket(bars, barIndex, name);
  }

  void closeAllShortAtMarket(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllShortAtMarket(bars, barIndex, name);
  }

  void closeAllLongAtMarket(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllLongAtMarket(bars, barIndex, name);
  }

  void closeAllAtClose(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllAtClose(bars, barIndex, name);
  }

  void closeAllShortAtClose(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllShortAtClose(bars, barIndex, name);
  }

  void closeAllLongAtClose(
      Bars bars, Index barIndex,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllLongAtClose(bars, barIndex, name);
  }
  ...
  void closeAllShortAtLimit(
      Bars bars, Index barIndex, double price,
      const std::string& name) throw(BarIndexOutOfRangeException) {
    positions().closeAllShortAtLimit(bars, barIndex, price, name);
  }
  ...
  void applyTimeBased(Index barIndex,
                      Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyTimeBased(bars(), barIndex, pos);
  }

  void applyStopLoss(Index barIndex,
                     Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyStopLoss(bars(), barIndex, pos);
  }

  void applyTrailing(Index barIndex,
                     Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyTrailing(bars(), barIndex, pos);
  }

  void applyBreakEvenStop(Index barIndex,
                          Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyBreakEvenStop(bars(), barIndex, pos);
  }

  void applyBreakEvenStopLong(Index barIndex,
                              Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyBreakEvenStopLong(bars(), barIndex, pos);
  }

  void applyBreakEvenStopShort(Index barIndex, Position pos) throw(
      BarIndexOutOfRangeException) {
    positions().applyBreakEvenStopShort(bars(), barIndex, pos);
  }

  void applyReverseBreakEvenStop(Index barIndex, Position pos) throw(
      BarIndexOutOfRangeException) {
    positions().applyReverseBreakEvenStop(bars(), barIndex, pos);
  }

  void applyReverseBreakEvenStopLong(Index barIndex, Position pos) throw(
      BarIndexOutOfRangeException) {
    positions().applyReverseBreakEvenStopLong(bars(), barIndex, pos);
  }

  void applyReverseBreakEvenStopShort(Index barIndex, Position pos) throw(
      BarIndexOutOfRangeException) {
    positions().applyReverseBreakEvenStopShort(bars(), barIndex, pos);
  }

  void applyProfitTarget(Index barIndex,
                         Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyProfitTarget(bars(), barIndex, pos);
  }

  void applyProfitTargetLong(Index barIndex,
                             Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyProfitTargetLong(bars(), barIndex, pos);
  }

  void applyProfitTargetShort(Index barIndex,
                              Position pos) throw(BarIndexOutOfRangeException) {
    positions().applyProfitTargetShort(bars(), barIndex, pos);
  }

  void applyAutoStops(Index barIndex) throw(BarIndexOutOfRangeException) {
    positions().applyAutoStops(bars(), barIndex);
  }
   ...
   */
  double low(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
   ...
   *                   thrown if the index is not within the series range
   */
  double high(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
   ...
   *                   thrown if the index is not within the series range
   */
  double open(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
   ...
   *                   thrown if the index is not within the series range
   */
  double close(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
   ...
   *                   thrown if the index is not within the series range
   */
  double volume(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
   ...
   *                   thrown if the index is not within the series range
   */
  DateTime time(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
    return _defBars.time(barIndex);
  }

  Date date(Index barIndex) const throw(SeriesIndexOutOfRangeException) {
    assert(_defBars);
    return _defBars.date(barIndex);
  }

  // TODO: to make System a OpenPositionHandler?
  void forEachOpenPosition(OpenPositionHandler& handler, Bars bars,
                           size_t barIndex) {
    assert(_defPositions);
  ...
  void forEachBar(BarHandler& handler,
                  Index startBar = 0) throw(BarIndexOutOfRangeException) {
    assert(_defBars);
  ...
  // temp Color object
  chart::Pane createPane(
      const std::string& name,
      const tradery::chart::Color background = chart::Color()) {
  ...
  ExplicitTrades& getExplicitTrades() {
    if (_explicitTrades == 0 || !_explicitTrades->hasExplicitTrades())
      throw SystemException(EXPLICIT_TRADES_NOT_AVAILABLE,
                            "No explicit trades available");
    else
      return *_triggers;
  }
  ...
  void autoApplyExplicitTrades(size_t barIndex) {
    ...
    //    std::cout << _T( "[BarSystem::autoApplyTriggers] getting triggers: " )
    //    << _defSymbol << _T( ", bar: " ) << barIndex << ( ", date: " ) <<
    //    time.date().to_iso_extended_string() << std::endl;
    if (_explicitTrades != 0)
      _explicitTrades->process(_defSymbol, time, barIndex, _defPositions,
                               _defBars);
  }

  virtual size_t positionCount() const { return _defPositions.positionCount(); }

  Position getPosition(PositionId id) throw(PositionIdNotFoundException) {
  ...
  const Series ChaikinADOscillator(unsigned int fastPeriod,
  ...
  const Series StochSlowK(int fastKPeriod, int slowKPeriod, MAType slowKMAType,
                          int slowDPeriod, MAType slowDMAType) const {
    return bars().StochSlowK(fastKPeriod, slowKPeriod, slowKMAType, slowDPeriod,
                             slowDMAType);
  }

  const Series StochSlowD(int fastKPeriod, int slowKPeriod, MAType slowKMAType,
                          int slowDPeriod, MAType slowDMAType) const {
    return bars().StochSlowD(fastKPeriod, slowKPeriod, slowKMAType, slowDPeriod,
                             slowDMAType);
  }

  const Series StochFastK(int fastKPeriod, int fastDPeriod,
                          MAType fastDMAType) const {
    return bars().StochFastK(fastKPeriod, fastDPeriod, fastDMAType);
  }

  const Series StochFastD(int fastKPeriod, int fastDPeriod,
                          MAType fastDMAType) const {
...
class CORE_API TickSystem : public Runnable, public System {
 ...
 public:
  ...
  void init(const DataCollection* data,
            PositionsManagerAbstr* positions) throw(TickSystemException) {
    assert(data != 0);
    assert(positions != 0);
    ...
    if (data != 0 && _defTicks == 0)
      // TODO: set the right code and message
      throw TickSystemException(TICK_SYSTEM_RECEIVED_NON_TICK_DATA_ERROR,
                                "Tick system received non-tick data");
